...
class ConfirmRemovalModalPayment extends Component {
  state = {
    modal: false
  };
  ...
  deletePayment = pk => {
    axios.delete(API_URL_PAYMENT + pk).then(() => {
        ...
        <Modal isOpen={this.state.modal} toggle={this.toggle}>
          ...
          <ModalFooter>
            ...
            <MDBBtn rounded
              ...
              color='danger'
              type="button"
              onClick={() => this.deletePayment(this.props.pk)}
            >
              Да
            </MDBBtn>
          </ModalFooter>
...
export default ConfirmRemovalModalPayment;